...
interface RelayerIncentivize {
    ...
    function HEADER_RELAYER_REWARD_RATE_DENOMINATOR()
        external
        view
        returns (uint256);

    function HEADER_RELAYER_REWARD_RATE_MOLECULE()
        external
        view
        returns (uint256);
    ...
    function bscChainID() external view returns (uint32);
    ...
    function collectedRewardForTransferRelayer()
        external
        view
        returns (uint256);
    ...
    function headerRelayerRewardRateDenominator()
        external
        view
        returns (uint256);
