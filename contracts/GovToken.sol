    ...
    ERC20VotesUpgradeable
{
    ...
    /*----------------- external functions -----------------*/
    /**
     * @dev Sync the account's govDC amount to the actual BNB value of the StakingCredit he holds
    ...
    /**
     * @dev Batch sync the account's govDC amount to the actual BNB value of the StakingCredit he holds
    ...
    /**
     * @dev delegate govDC votes to delegatee
