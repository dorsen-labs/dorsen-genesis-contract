    ...
    IApplication
{
    ...
    uint256 public constant MISDEMEANOR_THRESHOLD = 2 * 50; // lorentz(Phase One)
    uint256 public constant FELONY_THRESHOLD = 2 * 150; // lorentz(Phase One)
    ...
    uint256 public constant INIT_FELONY_SLASH_SCOPE = 2 * 28800; // 1 days(block number), 2 * lorentz phase 1 scope
